/**
 * Sherry Studio — Slide-over (drawer) lateral para CRM / Membresías / Equipo.
 *
 ...
 * cierra con Escape, clic en el velo o el botón de cerrar. Copia local para
 * evitar acoplamiento con otros módulos.
 */
