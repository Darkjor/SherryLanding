/**
 * Sherry Studio — Slide-over (drawer) lateral de la Agenda.
 *
 * Patrón de registro de producto: NO es un modal centrado. Se desliza desde la
 * derecha sobre un velo tenue, con cabecera (título), cuerpo desplazable y pie
 * opcional de acciones. Se cierra con Escape, clic en el velo o el botón cerrar.
 */
